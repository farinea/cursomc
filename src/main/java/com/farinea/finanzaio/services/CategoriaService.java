...
import com.farinea.finanzaio.dto.CategoriaDTO;
import com.farinea.finanzaio.repositories.CategoriaRepository;
import com.farinea.finanzaio.services.exceptions.DataIntegrityException;
...
public class CategoriaService {
	...
	public List<Categoria> findByTipo(Integer tipo) {
		return repo.findCategorias(tipo);
	}
	...
	public Categoria fromDTO(CategoriaDTO objDto) {
		return new Categoria(objDto.getId(),objDto.getNome(),objDto.getTipoConta(),objDto.getSaldoInicial());				
	}
	
	private void updateData(Categoria newObj, Categoria obj) {
		newObj.setNome(obj.getNome());
		newObj.setTipoConta(obj.getTipoConta());
		newObj.setSaldoInicial(obj.getSaldoInicial());
	}
